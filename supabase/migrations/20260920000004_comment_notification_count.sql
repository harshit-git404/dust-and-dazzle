-- ==============================================================================
-- Dust and Dazzle: Comment Notification Count Extension
-- Extends submit_reader_comment RPC to return recent_hourly_count for email throttling
-- ==============================================================================
...
BEGIN
    ...
    -- Return success and the count of comments created in the last hour (including this new one)
    RETURN jsonb_build_object(
        'success', true,
        'recent_hourly_count', v_global_hourly_count + 1
    );
END;
$$;
